...
/*
Checks if a Tetromino can be placed at a specified position (row, col) on the grid without
...
/*Places a Tetromino at a specified position (row, col) on the grid.
...
/*Removes a Tetromino from a specified position (row, col) on the grid, 
...
/*Attempts to place all Tetrominoes in tetro_group onto the grid using recursive backtracking. 
